    ...
    def execute(self, request_payload):
        ...
        try:
            ...
            result = {
                ...
                "payment_terms_reason": extracted_fields.get("payment_terms_reason"),
                "breach_clause_present": extracted_fields.get("breach_clause_present"),
                "breach_clause_reason": extracted_fields.get("breach_clause_reason"),
                "authorization_issue": extracted_fields.get("authorization_issue"),
                "authorization_issue_reason": extracted_fields.get("authorization_issue_reason"),
                "deviation_detected": extracted_fields.get("deviation_detected"),
                "deviation_reason": extracted_fields.get("deviation_reason"),
                "risk_reasons": extracted_fields.get("risk_reasons", []),
